"""Executor ID validation utility.

Provides strict pattern-based validation for executor identifiers.
Executor IDs are used in database records, certificate CN/SAN fields,
TOML config sections, and shell scripts — so they must follow a
tight allowlist to prevent injection attacks.
