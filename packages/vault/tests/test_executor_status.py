...
from vault.cli.api_client import Config
...
class TestParseExecutorCert:
    ...
    def test_parse_returns_none_for_missing_file(self):
        ...
        from vault.cli.commands import _parse_executor_cert
...
class TestGetServerUrl:
    ...
    def test_vault_url_arg_takes_precedence(self):
        """--vault-url arg is returned immediately."""
        from vault.cli.commands import _get_server_url

        args = MagicMock()
        args.vault_url = "https://my-vault.example.com"
        args.config_path = "/nonexistent/executor.toml"

        result = _get_server_url(args)
        assert result == "https://my-vault.example.com"
...
class TestExecutorStatus:
    ...
    def test_status_uses_vault_url_arg(self, tmp_path, capsys):
        """Status uses --vault-url arg for server URL display."""
        from vault.cli.commands import executor_status
        ...
        captured = capsys.readouterr()
        assert "https://my-vault.example.com" in captured.out
