...
from vault.cli.commands import cmd_credential_list, cmd_credential_add, cmd_credential_remove
...
class TestCredentialAdd:
    ...
    def test_add_credential_success(self):
        ...
        with patch("vault.cli.commands._elevate", return_value="elev_token_xyz"):
...
class TestCredentialRemove:
    ...
    def test_remove_credential_no_elevation(self):
        ...
        with patch("vault.cli.commands._elevate", side_effect=APIClientError("Elevation failed")):
            args = MagicMock()
            args.credential_id = "cred_001"
            args.json = False
