"""VaultFactory: builder pattern for creating Vault instances."""
...
class VaultFactoryError(Exception):
    """Factory error."""


class VaultFactory:
    """Factory for creating configured Vault instances.

    Usage:
        vault = VaultFactory.from_config(config).build()
    """
    ...
    @classmethod
    def from_config(cls, config: BackendConfig) -> VaultFactory:
    ...
    @classmethod
    def from_dict(cls, config_dict: dict) -> VaultFactory:
    ...
    def with_kek(self, kek: bytes) -> VaultFactory:
    ...
    def build(self) -> Vault:
        ...
        Raises:
            VaultFactoryError: If KEK is not available.
        """
